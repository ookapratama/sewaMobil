    ...
    <div class="col-12">
        <div class="card top-selling overflow-auto">
            <div class="card-body pb-0">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#scrollingModal"> Tambah Data </button>
                </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-6">
                        <div class="col-md-12">
                            ...
                            <input type="date" name="start-date" class="form-control" placeholder="Pilih Tanggal" required></input>
                        </div>
                    </div>
                    <div class="mb-6">
                        <div class="col-md-12">
                            <label for="start-date">End-Date</label>
                            <input type="date" name="start-date" class="form-control" placeholder="Masukan Harga.." required></input>
                        </div>
                    </div>
                    <div class="mb-6">
                        <div class="col-md-12">
                    ...
                    <div class="mb-6">
                        <div class="col-md-12">
                            ...
                            <input type="adress" name="address" class="form-control" placeholder="Alamat.." required>
                        </div>
                    </div>
                    <div class="mb-6">
                        <div class="col-md-12">
                            <label for="invoice">Bukti Pembayaran</label>
                            <input type="file" name="invoice" class="form-control" placeholder="Upload.." required>
                        </div>
                    </div>
                    <div class="mb-6">
                        <div class="col-md-12">
                            <label for="ktp">KTP</label>
                            <input type="file" name="ktp" class="form-control" placeholder="Upload.." required>
                        </div>
                    </div>
                    <div class="mb-6">
                        <div class="col-md-12">
                            <label for="sim">SIM</label>
                            <input type="file" name="sim" class="form-control" placeholder="Upload.." required>
                        </div>
                    </div>
                    <div class="mb-6">
