<body>
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link {{ $title == 'Dashboard' ? 'active' : 'collapsed' }}" href="{{ route('dashboard') }} "> <i class="bi bi-grid">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $title == 'Transaction' ? 'active' : 'collapsed' }}" href="{{route('transaction.index') }}"> <i
            ...
            <li class="nav-item">
                <a class="nav-link {{ $title == 'Driver' ? 'active' : 'collapsed' }}" href="{{route('driver.index') }}"> <i
